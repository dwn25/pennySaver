 ...
 * @author DNartey
 */
public class EnterStockMainMenuPage extends javax.swing.JFrame {

    /**
     * Creates new form EnterStockMainMenuPage
     */
    public EnterStockMainMenuPage() {
    ...
    public void passing(EnterStockMainMenuPage s){
        s.hide();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnterStockMainMenuPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnterStockMainMenuPage().setVisible(true);
            }
        });
    }
